...
class Store extends \yii\db\ActiveRecord
{
    ...
    public function rules()
    {
        return [
            ...
            [['name', 'email', 'stand_name', 'store_name'], 'string', 'max' => 127],
            [['slogan'], 'string', 'max' => 251],
            [['rif'], 'string', 'max' => 11],
            [['facebook', 'twitter', 'instagram'], 'string', 'max' => 47],
            [['address'], 'string', 'max' => 773],
            [['stand_hash', 'store_hash'], 'string', 'max' => 31],
            [['status'], 'string', 'max' => 2],
        ];
    }
    ...
    public function attributeLabels()
    {
        return [
            ...
            'stand_hash' => Yii::t('app', 'Stand Hash'),
            'stand_name' => Yii::t('app', 'Stand Name'),
            'store_hash' => Yii::t('app', 'Store Hash'),
